...
//			}
	...
	int getColor(int i) {
		...
		//return Color.argb(0xff, 0xff, 0xff, 0xff);//白
		
		//return Color.argb(0xff, 0x26, 0xc9, 0xff);//蓝
		return Color.argb(a, 0xfe, 0x45, 0x43);//红
		//return Color.argb(a, 0xff, 0xbb, 0x32);//橙
		//return Color.argb(a, 0x98, 0xcc, 0x00);//绿
